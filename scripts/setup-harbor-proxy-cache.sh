...
HARBOR_PASS="${HARBOR_ADMIN_PASS:-CHANGEME}"
...
log_info "Pull images via: harbor.example.com/<registry>/<image>:<tag>"
log_info "  Example: harbor.example.com/docker.io/library/nginx:latest"
